...
let UserController = class UserController {
    ...
    async getSingleUser(id) {
        return await __classPrivateFieldGet(this, _UserController__service, "f").getSingleUser(+id);
    }
    async createUser(createUserPayload, image) {
        await __classPrivateFieldGet(this, _UserController__service, "f").createUser(createUserPayload, image);
        return {
            message: 'User created successfully',
            new_user: createUserPayload
        };
    }
    async updateUser(id, updateUserPayload) {
        await __classPrivateFieldGet(this, _UserController__service, "f").updateUser(+id, updateUserPayload);
        return {
    ...
    async delteUser(id) {
        return __classPrivateFieldGet(this, _UserController__service, "f").deleteUser(+id);
    }
};
