...
let LikesController = class LikesController {
    ...
    async createLike(createLikePayload) {
        return await this.likesService.createLike(createLikePayload);
    }
    async updateLike(id, updateLikePayload) {
...
], LikesController.prototype, "getAllLikes", null);
__decorate([
    (0, common_1.Get)("/:id"),
    ...
    __metadata("design:returntype", Promise)
], LikesController.prototype, "getSingleLike", null);
__decorate([
    (0, common_1.Post)('/add'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dtos_1.CreateLikeDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dtos_1.UpdateLikeDto]),
    __metadata("design:returntype", Promise)
], LikesController.prototype, "updateLike", null);
__decorate([
